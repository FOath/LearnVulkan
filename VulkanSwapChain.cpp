...
#endif
{
	...
	{
		// If there's no queue that supports both present and grphics
	...
	// todo : Add support for seprate graphics and presenting queue
...
/// <summary>
/// Set instance, physical and logical device to use for the swapchain and get all required pointers
/// </summary>
...
/// <summary>
/// Create the swapchain and get its image with given width and height
/// </summary>
/// <param name="width">Pointer to the width of the swapchain (may be adjusted to fit the requirements of the swapchain)</param>
/// <param name="height">Pointer to the height of the swapchain (may be adjusted to fit the requirements of the swapchain)</param>
/// <param name="vsync">(Optional) Can be used to force vsync-ed redering (by using VK_PRESENT_MODE_FIFO_KHR as a presentation mode)</param>
...
void VulkanSwapChain::create(uint32_t* width, uint32_t* height, bool vsync, bool fullscreen)
{
	...
	// The VK_PRESENT_MODE_FIFO_KHR mode must always be present asa per spec
...
/// </summary>
/// <param name="presentCompleteSemaphore">(Optional) Semaphore that is signaled then the image is ready for use</param>
/// <param name="imageIndex">Pointer to the image index that will be increased if the next image could be acquired</param>
/// <returns></returns>
...
/// </summary>
/// <param name="queue">Presentation queue for presenting the image</param>
/// <param name="imageIndex">Index of the swapchain image to queue for presentation</param>
/// <param name="waitSemaphore">(Optional) Semaphore that is waited on before the image is presented (only used if != VK_NULL_HANDLE)</param>
/// <returns></returns>
