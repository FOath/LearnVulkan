...
protected:
	// Returns the path to the root of the glsl or hlsl shader library.
...
public:
	...
	// For use in animation, rotation, etc
	float timer = 0.0f;
...
// true if application has focused, false if moved to background
	...
	// Setup the vulkan instance, enable required extensions and connect to the physical devcie (GPU)
	bool initVulkan();
	...
	/// <summary>
	/// (Virtual) Called when the window has been resized, can be used by the sample applicaiton to recreate resources
	/// </summary>
	...
	/// <summary>
	/// (Virtual) Called after the physical device extensions have been read, can be used to enable extensions based on the supported extension listing
	/// </summary>
