...
namespace vks
{
	...
	/// </summary>
	void UIOverlay::prepareResource()
	{
		ImGuiIO& io = ImGui::GetIO();
	...
	void UIOverlay::preparePipeline(const VkPipelineCache pipelineCache, const VkRenderPass renderPass, const VkFormat colorFormat, const VkFormat depthFormat)
	{
		...
		std::vector<VkVertexInputAttributeDescription> vertexInputAttributes{
			...
			vks::initializers::vertexInputAttributeDescription(0, 2, VK_FORMAT_R8G8B8A8_UNORM, offsetof(ImDrawVert, col)),	// Location 2: Color
		};
	...
	bool UIOverlay::update()
	{
		...
		ImDrawVert* idxDst = (ImDrawVert*)indexBuffer.mapped;
