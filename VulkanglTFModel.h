...
namespace vkglTF
{
	...
	*/
	struct Material
	{
		...
		vkglTF::Texture* specularGlossinessTextures;
	...
	*/
	...
	struct Vertex
	{
		...
		static std::vector<VkVertexInputAttributeDescription> inputAttributeDescription(uint32_t binding, const std::vector<VertexComponent> components);
		/// <summary>
